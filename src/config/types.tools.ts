...
export type ToolsConfig = {
  ...
  web?: {
    search?: {
      ...
      enabled?: boolean;
      /** Search provider ("brave", "firecrawl", "gemini", "grok", "kimi", "perplexity", or "tavily"). */
      provider?: "brave" | "firecrawl" | "gemini" | "grok" | "kimi" | "perplexity" | "tavily";
      ...
      tavily?: {
        ...
        apiKey?: SecretInput;
        /** Base URL for Tavily API requests (defaults to "https://api.tavily.com"). */
        baseUrl?: string;
      };
    };
    fetch?: {
